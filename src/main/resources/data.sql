...
--
-- INSERT INTO SEAT_RESERVATION (ID, CONCERT_ID, SCHEDULE_ID, SEAT_ID, USER_ID, CREATED_AT, STATUS, VERSION) VALUES (1, 1, 1, 5, 10,  DATEADD('DAY', -1, CURRENT_TIMESTAMP), 'PENDING', 0);
